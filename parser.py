...
#Выбор режима работы
work_mode = input('Введите режим работы ( 1 - поиск и добавлений новых записей, 2 - извлечение всех записей БД, 3 - форматироние БД; по умолчанию - 1): ')
    ...
    while (current_pos >= 0):
        ...
        try:
            with open(file_name, "a") as file:
                file.write('профессия: ' + current_job + ', компания: ' +current_company + ', ссылка: ' + current_link + ', зп: ' + current_price + '\n')
        except:
            pass